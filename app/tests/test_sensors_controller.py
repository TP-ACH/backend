...
def test_get_device_data_temperature(client, test_db):
    response = client.get(
        "/sensors/test_db?sensor=temperature&start_date=2024-09-01&end_date=2024-09-03"
    )
...
def test_get_device_data_ph(client, test_db):
    response = client.get(
        "/sensors/test_db?sensor=ph&start_date=2024-09-01&end_date=2024-09-03"
    )
...
def test_get_device_data_date_filter(client, test_db):
    response = client.get(
        "/sensors/test_db?sensor=temperature&start_date=2024-09-02&end_date=2024-09-03"
    )
...
def test_get_device_data_invalid_date(client, test_db):
    response = client.get(
        "/sensors/test_db?sensor=temperature&start_date=2024-09-01&end_date=2024-09-33"
    )
...
def test_get_device_data_invalid_device_id(client, test_db):
    response = client.get(
        "/sensors/invalid_db?sensor=temperature&start_date=2024-09-01&end_date=2024-09-03"
    )
